  ...
  <template>
    <section class="hero-section">
      <div class="hero-content">
        ...
        <div class="hero-text-container">
          ...
          <hr class="border-0 h-[2.5px] w-full max-w-[500px] bg-[#9e827b] mb-5">
    ...
    <section>
      ...
      <p class="text-black ml-14 mr-14 pb-10 text-left text-[20px] text-xl font-sans">
        ...
        <span class="block mb-2"></span> <!-- Adds a thinner space between paragraphs -->
        ...
        <span class="block mb-2"></span> <!-- Adds another thin space -->
